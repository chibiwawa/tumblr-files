...
document.addEventListener('mousemove', function(e) {
    ...
    // --- HYDRANGEA TRAIL LOGIC ---
    if (Math.random() > 0.85) { // Controls how many petals appear
...
function createTrailItem(x, y) {
    ...
    // Randomly choose between petal and leaf
...
document.addEventListener('mousedown', function(e) {
    ...
    // Tiny "droplets" popping out of the splash
    for(var i=0; i<4; i++) {
